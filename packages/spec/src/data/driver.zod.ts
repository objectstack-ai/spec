...
export const DriverInterfaceSchema = z.object({
   ...
   */
  execute: z.function(
    z.tuple([z.any(), z.array(z.any()).optional(), DriverOptionsSchema.optional()]),
    z.promise(z.any())
   ...
   */
  find: z.function(
    z.tuple([z.string(), QuerySchema, DriverOptionsSchema.optional()]),
    z.promise(z.array(z.record(z.any())))
  ...
  findOne: z.function(
    z.tuple([z.string(), QuerySchema, DriverOptionsSchema.optional()]),
    z.promise(z.record(z.any()).nullable())
   ...
   */
  create: z.function(
    z.tuple([z.string(), z.record(z.any()), DriverOptionsSchema.optional()]),
   ...
   */
  update: z.function(
    z.tuple([z.string(), z.string().or(z.number()), z.record(z.any()), DriverOptionsSchema.optional()]),
    z.promise(z.record(z.any()))
   ...
   */
  upsert: z.function(
    z.tuple([z.string(), z.record(z.any()), z.array(z.string()).optional(), DriverOptionsSchema.optional()]),
    z.promise(z.record(z.any()))
   ...
   */
  delete: z.function(
    z.tuple([z.string(), z.string().or(z.number()), DriverOptionsSchema.optional()]),
    z.promise(z.boolean())
   ...
   */
  count: z.function(
    z.tuple([z.string(), QuerySchema.optional(), DriverOptionsSchema.optional()]),
    z.promise(z.number())
  ...
  bulkCreate: z.function(
    z.tuple([z.string(), z.array(z.record(z.any())), DriverOptionsSchema.optional()]),
    z.promise(z.array(z.record(z.any())))
  ),
  ...
  bulkUpdate: z.function(
    z.tuple([z.string(), z.array(z.object({ id: z.string().or(z.number()), data: z.record(z.any()) })), DriverOptionsSchema.optional()]),
    z.promise(z.array(z.record(z.any())))
  ),
  ...
  bulkDelete: z.function(
    z.tuple([z.string(), z.array(z.string().or(z.number())), DriverOptionsSchema.optional()]),
    z.promise(z.void())
  ),
  ...
  updateMany: z.function(
    z.tuple([z.string(), QuerySchema, z.record(z.any()), DriverOptionsSchema.optional()]),
    z.promise(z.number())
  ).optional(),
  ...
  syncSchema: z.function(
    z.tuple([z.string(), z.any(), DriverOptionsSchema.optional()]),
    z.promise(z.void())
  ...
  dropTable: z.function(
    z.tuple([z.string(), DriverOptionsSchema.optional()]),
    z.promise(z.void())
  ),
