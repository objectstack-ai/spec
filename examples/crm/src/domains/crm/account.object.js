...
exports.Account = spec_1.ObjectSchema.create({
    name: 'account',
    label: 'Account',
    ...
    fields: {
        ...
        account_number: spec_1.Field.autonumber({
        ...
        billing_address: spec_1.Field.address({
            label: 'Billing Address',
            addressFormat: 'international',
        }),
        // Office Location (new field type)
        office_location: spec_1.Field.location({
        ...
        parent_account: spec_1.Field.lookup('account', {
        ...
        // Boolean field
        is_active: spec_1.Field.boolean({
            label: 'Active',
            defaultValue: true,
        }),
        // Date field
        last_activity_date: spec_1.Field.date({
            label: 'Last Activity Date',
            readonly: true,
        }),
        // Brand color (new field type)
        brand_color: spec_1.Field.color({
            label: 'Brand Color',
            colorFormat: 'hex',
