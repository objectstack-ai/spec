...
<Cards>
  <Card
    ...
    href="/docs/developer"
    description="Quick Start tutorial: create a project, define objects, launch the Studio."
  />
  <Card
    icon={<FolderOpen />}
    title="Example Apps"
  ...
  <Card
    ...
    description="All 11 commands: init, generate, serve, studio, compile, validate, and more."
  />
  <Card
    icon={<Compass />}
    title="Introduction"
