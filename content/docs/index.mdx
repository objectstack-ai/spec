...
import { Book, Compass, FileText, Layers, Database, Layout, Cpu, Code2, Bot, Workflow, Shield, Globe } from 'lucide-react';
...
<Cards>
  ...
  <Card
    ...
    href="/docs/framework"
    description="Guides for writing plugins, CLI tools, and extending the platform."
  />
</Cards>
