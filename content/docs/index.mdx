...
import { Book, Compass, FileText, Layers, Database, Layout, Cpu, Code2, Bot } from 'lucide-react';
...
<Cards>
  ...
  <Card
    ...
    title="AI & Automation"
    href="/docs/ai"
    description="AI-driven development with the ObjectStack Builder. Automated metadata generation and deployment."
  />
  <Card
    icon={<Code2 />}
    title="Developers"
