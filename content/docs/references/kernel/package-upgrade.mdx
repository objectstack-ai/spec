...
| **changeType** | `Enum<'added' \| 'modified' \| 'removed' \| 'renamed'>` | ✅ |  |
...
| **phase** | `Enum<'pending' \| 'analyzing' \| 'snapshot' \| 'executing' \| 'migrating' \| 'validating' \| 'completed' \| 'failed' \| 'rolling-back' \| 'rolled-back'>` | ✅ |  |
