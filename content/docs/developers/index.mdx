...
<Cards>
  ...
  <Card icon="code" title="Examples" href="https://github.com/objectstack-ai/spec/tree/main/examples">
...
- **Repository**: [github.com/objectstack-ai/spec](https://github.com/objectstack-ai/spec)
- **Discord**: [discord.gg/objectstack](https://discord.gg/objectstack)
- **GitHub Issues**: [github.com/objectstack-ai/spec/issues](https://github.com/objectstack-ai/spec/issues)
